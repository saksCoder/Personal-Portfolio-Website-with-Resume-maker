...
class SkillsForm(forms.ModelForm):
    class Meta:
        model = Skills
        fields = ("skill_detail",)
        widgets = {"skill_detail": forms.Textarea(attrs={"title": "Skill_detail"})}
...
class ProjectsForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {"project_detail": forms.Textarea(attrs={"title": "Project_detail"})}
...
class AboutForm(forms.ModelForm):
    class Meta:
        model = About
        fields = ("about_detail",)
        widgets = {"about_detail": forms.Textarea(attrs={"title": "About_detail"})}
...
class AwardsForm(forms.ModelForm):
    class Meta:
        model = Awards
        fields = ("award_detail",)
        widgets = {"award_detail": forms.Textarea(attrs={"title": "Award_detail"})}
